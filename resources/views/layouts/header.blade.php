...
<div class="flex-column-center mr-10 @if(auth()->check() && auth()->user()->IsManager()) ml-a @endif">
    <div>10:00</div>
    <div>22:30</div>
</div>
...
<div class="flex-column-center">
    ...
    <div class="container-profile-and-basket flex-center pr-5">
        <div onclick="{{$actionConditionAuth}}" class="container-profile flex-column-center text-center cp p-5 {{$authCheck ? 'color-green' : ''}}">
            ...
            <div class="text-center container-profile-text">
                @if($authCheck)
                    Профиль
                @else
                    Вход
        ...
        <div class="button-basket color-white flex-column-center text-center cp">
            <div class="pos-rel">
                ...
                <div class="amount-item-in-basket hide  pos-abs right-0 p-5 bg-orange color-white flex-center">
                    0
                </div>
            </div>
