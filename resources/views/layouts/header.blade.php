<div class="logo-container flex-center" style="max-width: 100px;">
    <a class="flex-center w-100" href="{{route('home-page')}}">
        <div class="logo w-100 h-100">
            <img class="w-100" src="{{url('logoSvg.svg')}}" alt="">
        </div>
    </a>
</div>
...
<div class="flex-center p-5">
    ...
    @endphp
    <div onclick="{{$actionConditionAuth}}" class="container-profile flex-column-center text-center cp p-5 mx-15">
        <div>
    ...
    <div class="button-basket flex-column-center text-center cp p-5 mx-15">
        <div class="pos-rel">
