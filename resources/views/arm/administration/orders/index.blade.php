        ...
        <div>
            <table class="w-100 border table-sort" id="orders-report" style="width: max-content;">
                ...
                <tr>
                    ...
                    <th data-title-column-id="17" class="table-columns w-0">Имя заказавшего</th>
                    <th data-title-column-id="18" class="table-columns w-0">Кол-во заказов у клиента</th>
                    <th data-title-column-id="19" class="table-columns ">Адрес</th>
                    ...
                    <th data-title-column-id="24" class="table-columns w-0">Есть комбо?</th>
                    <th data-title-column-id="25" class="table-columns w-0">Сумма</th>
                    <th data-title-column-id="26" class="table-columns w-0">Себестоимость заказа</th>
                    <th data-title-column-id="27" class="table-columns w-0">Прибыль</th>
                    <th data-title-column-id="28" class="table-columns w-0">Подробнее</th>
                </tr>
                </thead>
                <tbody>
                ...
                @foreach($orders as $order)
                    <tr class="order hover-color">
                        ...
                        <td data-column-id="17" class="text-center">{{$order->clientInfo->clientName}}</td>
                        <td data-column-id="18" class="text-center">{{$order->clientInfo->ordersCount}}</td>
                        <td data-column-id="19">{{$order->clientInfo->clientAddressDelivery}}</td>
                        ...
                        <td data-column-id="24" class="text-center">{{$order->issetCombo}}</td>
                        <td data-column-id="25" class="text-center">{{$order->amount}}</td>
                        <td data-column-id="26" class="text-center">{{number_format($order->cost, 2, '.', '')}}</td>
                        <td data-column-id="27" class="text-center">{{number_format($order->margin, 2, '.', '')}}</td>
                        <td data-column-id="28" class="text-center">
